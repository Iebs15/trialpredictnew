...
function EvidencePage() {
  ...
  return (
    <BasePage
      ...
      description={`${symbol} is associated with ${name} through TrialPredict Platform evidence that is aggregated from genetic evidence, somatic mutations, known drugs, differential expression experiments, pathways & systems biology, text mining, and animal model data sources`}
      location={location}
    >
