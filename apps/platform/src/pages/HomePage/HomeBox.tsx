  ...
  return (
    <Grid item xs={12} sm={12} md={8} lg={8}>
      <Paper elevation={1} sx={styles.homeboxContainer}>
        <Box sx={{ ...styles.homeboxHeader, fontWeight: 'bold', fontSize: '2rem' }}>
          TrialPredict by InsiMine
        </Box>
      ...
      {isPartnerPreview && (
        <Paper elevation={1} sx={styles.dataPolicy}>
          <Typography variant="body2">
            The TrialPredict Partner Preview Platform is for consortium members only. Data is
