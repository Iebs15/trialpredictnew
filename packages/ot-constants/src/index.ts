...
export const externalLinks = {
  ...
  network: [
    ...
    { label: "TrialPredict Genetics", url: "https://genetics.opentargets.org" },
...
// App Metadata
export const appTitle = "TrialPredict Platform";
export const appDescription =
  "The TrialPredict Platform is a data integration tool that supports systematic drug target identification and prioritisation";
